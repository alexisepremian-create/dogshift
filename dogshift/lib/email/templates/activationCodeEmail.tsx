            ...
            <tbody>
              <tr>
                <td style={{ padding: 0, lineHeight: "0px", fontSize: "0px" }}>
                  ...
                  <img src={`${baseUrl}/email-banners/banner-mobile.jpg`} width="600" alt="" style={{ display: "block", width: "100%", maxWidth: "600px", border: 0, borderRadius: "16px 16px 0 0" }} />
                </td>
              </tr>
              <tr>
                <td style={{ backgroundColor: "#ffffff", padding: "22px 36px 28px", textAlign: "center", borderRadius: "0 0 16px 16px" }}>
                  <p style={{ margin: "0 0 14px", fontFamily: "-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif", fontSize: 15, fontWeight: 700, color: "#0f172a" }}>Prêt à débuter ? Explorez notre plateforme</p>
                  <a href={`${baseUrl}/sitters`} style={{ backgroundColor: "#6366f1", color: "#ffffff", fontFamily: "-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif", fontSize: 14, fontWeight: 700, textDecoration: "none", padding: "13px 28px", borderRadius: 10, display: "inline-block" }}>Découvrir DogShift →</a>
                </td>
              </tr>
            </tbody>
          </table>
