  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-white text-slate-900">
      ...
      <div className="pointer-events-none absolute inset-0 z-0 overflow-hidden">
        <Dog className="absolute right-8 top-32 h-48 w-48 rotate-12 text-[#7c3aed]/20" strokeWidth={1.5} />
        ...
        <MapPin className="absolute bottom-24 right-12 h-40 w-40 rotate-12 text-[#7c3aed]/[0.04]" strokeWidth={1.5} />
        <Calendar className="absolute left-[25%] top-20 h-20 w-20 -rotate-6 text-[#7c3aed]/[0.04]" strokeWidth={1.5} />
        <Home className="absolute bottom-20 right-[25%] h-24 w-24 rotate-6 text-[#7969F0]/[0.04]" strokeWidth={1.5} />
      </div>

      <main className="relative z-10 mx-auto max-w-6xl px-4 py-14 sm:px-6">
