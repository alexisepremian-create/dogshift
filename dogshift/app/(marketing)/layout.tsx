              ...
              <div className="mt-4 flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div className="flex flex-wrap items-center gap-5 text-slate-400">
                    <VisaLogo className="h-8 w-auto transition-colors duration-300 hover:text-[#1434CB]" />
                    <MastercardLogo className="h-7 w-auto grayscale transition-[filter] duration-300 hover:grayscale-0" />
                    <ApplePayLogo className="h-6 w-auto transition-colors duration-300 hover:text-slate-900" />
                    <TwintLogo className="h-6 w-auto transition-colors duration-300 hover:text-[#000000]" />
                  </div>
                </div>
              </div>
            </div>
