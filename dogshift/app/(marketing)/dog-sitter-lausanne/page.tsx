...
const title = "Dog sitter Lausanne – Trouver un dog sitter à Lausanne | DogShift";
const description = "Trouvez un dog sitter à Lausanne avec DogShift. Dog-sitting Lausanne, promenade, garde chien Lausanne et pension avec une expérience premium et des profils de confiance.";
