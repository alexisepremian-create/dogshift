  ...
  },
  {
    ...
    templates: [
      ...
      },
      {
        ...
        description: "Envoyé au sitter quand son logement est approuvé manuellement par l'équipe",
        badge: "Approuvé",
        badgeColor: "bg-green-100 text-green-700",
      },
      {
        ...
        description: "Envoyé quand les photos sont reçues et en attente d'examen manuel par l'équipe",
        badge: "En attente",
        badgeColor: "bg-amber-100 text-amber-700",
      },
      {
        id: "pension-rejected",
        label: "Photos non retenues",
        description: "Envoyé au sitter quand ses photos sont refusées manuellement, avec conseils d'amélioration",
        badge: "Refusé",
        badgeColor: "bg-red-100 text-red-700",
      },
    ],
