  ...
  try {
    ...
    if (profile.user?.email) {
      ...
      await sendEmail(
        ...
        {
          templateName: "sitter-pension-verification-submitted",
          context: "api:host/pension-verification/submit",
          targetUserId: userId,
          metadata: { sitterId: profile.sitterId, photoCount: photoKeys.length },
        },
