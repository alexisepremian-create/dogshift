          ...
          <div className="pt-20 sm:pt-24 lg:pt-28">
            <div className="max-w-[640px]">
              ...
              <div className="mt-6 lg:hidden">
                <div className="rounded-3xl bg-white/70 p-4 shadow-[0_18px_60px_-44px_rgba(2,6,23,0.22)] ring-1 ring-slate-200/70 backdrop-blur">
                  <TypewriterBubbles variant="stacked" active />
                </div>
              </div>
            </div>
          </div>
