...
export default function HostShell({ children }: { children: React.ReactNode }) {
  ...
  const hideHomeLink = pathname === "/host/requests" || pathname === "/host/messages";
    ...
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <div className="mx-auto max-w-6xl px-4 pb-10 sm:px-6">
        <div className="mx-auto max-w-5xl">
          {!hideHomeLink ? (
            <Link href="/" className="inline-flex items-center gap-2 text-sm font-semibold text-slate-500 hover:text-[var(--dogshift-blue)]">
