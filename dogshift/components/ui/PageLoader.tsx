...
const LETTERS: { d: string; delay: number }[] = [
  {
    delay: 0.6,
    d: "M4500 4900 l0 -640 248 0 c137 0 275 5 308 11 162 30 291 148 338 309 45 152 41 510 -7 643 -49 134 -113 207 -231 263 -101 48 -149 54 -417 54 l-239 0 0 -640z m527 367 c102 -52 131 -122 140 -332 14 -345 -52 -442 -308 -451 l-109 -3 0 411 0 411 113 -5 c95 -4 120 -9 164 -31z",
  },
  {
    delay: 0.7,
