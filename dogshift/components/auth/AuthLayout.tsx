...
export default function AuthLayout({ children }: { children: ReactNode }) {
  return (
    <div className="min-h-screen bg-white text-slate-900">
      <div className="mx-auto flex min-h-screen w-full max-w-[480px] flex-col px-6 py-6">
        ...
        <div className="flex flex-1 flex-col justify-center py-8 sm:-translate-y-6">{children}</div>
